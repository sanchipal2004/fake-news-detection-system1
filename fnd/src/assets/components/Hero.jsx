...
const Hero = () => {
  ...
  whileTap={{ scale: 0.97 }}>
             ...
             <h1 className='text-xl font-bold'>News Article Analysis</h1>
...
<motion.div className="card2 w-72  rounded-md p-5  border border-10 " initial={{x:-100 ,opacity:0 ,scale:0.8}}
  ...
  whileTap={{ scale: 0.97 }}>
             ...
             <h1 className=' text-xl font-bold'>Confidence Score</h1>
...
<motion.div className="card3 w-72  rounded-lg  border border-10 p-5 "initial={{x:-100 ,opacity:0 ,scale:0.8}}
  ...
  whileTap={{ scale: 0.97 }}>
             ...
             <h1 className='text-xl font-bold '>Analyze News URLs</h1>
